  ...
  return (
    ...
    <section className="sec-block p-0">
			...
			<div className="page-content">
				...
				<div className="container">
					<div className="main-banner-text title-hd max-width-80">
						...
						<h1>Applicaton Development for Your Business <span></span></h1>
					</div>
						...
						<div className="row">
							<div className="col-lg-9">
								<div className="service-details-content">
									...
									<div className="row">
										<div className="col-lg-4">
											<div className="wk-text">
												...
												<p>We will help you to outperform your competitors.</p>
											</div>
										</div>
										<div className="col-lg-4">
											<div className="wk-text">
									...
									<p>Front-end development tools are focused on the UI/UX and provide UI design tools, SDKs to access device features, cross-platform support.</p>
							...
							<div className="col-lg-3">
								<div className="sidebar">
									<div className="widget widget-categories">
										<ul>
											<li><a href="#" title="">UI/UX and Brand</a></li>
											<li><a href="#" title="">SEO & SMM</a></li>
											<li><a href="#" title="">App development</a></li>
											<li><a href="#" title="">web development</a></li>
											<li><a href="#" title="">e - commerce</a></li>
											<li><a href="#" title="">Marketing Strategy</a></li>
										</ul>
									</div>
									<div className="widget widget-help">
										<h3>How can we help you?</h3>
										<p>Don’t know where to start? We’ll help you.</p>
										<a href="#" title="" className="btn-default2">contact us</a>
									</div>
									<div className="widget widget-newslettter">
										<h3>Newsletter</h3>
										<form>
											<input type="email" name="email" placeholder="Email" />
											<button type="submit"><img src="images/vector.svg" alt="" /></button>
										</form>
										<ul className="lang-slct">
		...
		<section className="sec-block">
			...
			<div className="container">
				<div className="main-banner-text title-hd wow fadeInUp mgb-100" data-wow-delay="300ms">
					...
					<p className="bdy">We’ve got a lot of awards for our products and services that became popular in the world.</p>
				</div>
				<div className="prices-section text-center">
					<div className="row">
						<div className="col-lg-4 col-md-6 col-sm-6">
							<div className="price-col">
								...
								<a href="#" title="" className="btn-default">Buy Now</a>
							</div>
						</div>
						<div className="col-lg-4 col-md-6 col-sm-6">
		...
		<section className="sec-block">
			...
			<h2 className="page-number">03.</h2>
			<div className="container">
